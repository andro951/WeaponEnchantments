        ...
        public static void GetChestLoot(ChestID chestID, out List<int> itemTypes, out float chance) {
            ...
            switch (chestID) {
                case ChestID.Chest: //Chest
                    ...
                    break;
                case ChestID.GoldChest: //Gold Chest
                    itemTypes.Add(ModContent.ItemType<CriticalStrikeChanceEnchantmentBasic>());
                    ...
                    itemTypes.Add(ModContent.ItemType<AttackSpeedEnchantmentBasic>());
                    break;
                case ChestID.GoldChestLocked: //Gold Chest (Locked)
                    itemTypes.Add(ModContent.ItemType<AllForOneEnchantmentBasic>());
                    itemTypes.Add(ModContent.ItemType<OneForAllEnchantmentBasic>());
                    break;
                case ChestID.ShadowChest: //Shadow Chest
                case ChestID.ShadowChestLocked: //Shadow Chest (Locked)
                    chance *= 2f;
                    ...
                    break;
                case ChestID.RichMahoganyChest: //Rich Mahogany Chest (Jungle)
                    itemTypes.Add(ModContent.ItemType<CriticalStrikeChanceEnchantmentBasic>());
                    break;
                case ChestID.IvyChest: //Ivy Chest (Jungle)
                    itemTypes.Add(ModContent.ItemType<CriticalStrikeChanceEnchantmentBasic>());
                    break;
                case ChestID.FrozenChest: //Frozen Chest
                    itemTypes.Add(ModContent.ItemType<ReducedManaUsageEnchantmentBasic>());
                    break;
                case ChestID.LivingWoodChest: //Living Wood Chest
                    itemTypes.Add(ModContent.ItemType<SizeEnchantmentBasic>());
                    break;
                case ChestID.SkywareChest: //Skyware Chest
                    itemTypes.Add(ModContent.ItemType<AttackSpeedEnchantmentBasic>());
                    break;
                case ChestID.WebCoveredChest: //Web Covered Chest
                    itemTypes.Add(ModContent.ItemType<AmmoCostEnchantmentBasic>());
                    break;
                case ChestID.LihzahrdChest: //Lihzahrd Chest
                    chance *= 2f;
                    itemTypes.Add(ModContent.ItemType<ArmorPenetrationEnchantmentBasic>());
                    itemTypes.Add(ModContent.ItemType<LifeStealEnchantmentBasic>());
                    itemTypes.Add(ModContent.ItemType<AllForOneEnchantmentBasic>());
                    itemTypes.Add(ModContent.ItemType<OneForAllEnchantmentBasic>());
                    break;
                case ChestID.WaterChest: //Water Chest
                    itemTypes.Add(ModContent.ItemType<ReducedManaUsageEnchantmentBasic>());
                    break;
                case ChestID.DungeonJungleChest: //Jungle Chest
                    chance = 1f;
                    //itemTypes.Add(ModContent.ItemType<Enchantment>());
                    break;
                case ChestID.DungeonCorruptionChest: //Corruption Chest
                    chance = 1f;
                    //itemTypes.Add(ModContent.ItemType<Enchantment>());
                    break;
                case ChestID.DungeonCrimsonChest: //Crimson Chest
                    chance = 1f;
                    //itemTypes.Add(ModContent.ItemType<Enchantment>());
                    break;
                case ChestID.DungeonHallowedChest: //Hallowed Chest
                    chance = 1f;
                    //itemTypes.Add(ModContent.ItemType<Enchantment>());
                    break;
                case ChestID.DungeonIceChest: //Ice Chest
                    chance = 1f;
                    //itemTypes.Add(ModContent.ItemType<Enchantment>());
                    break;
                case ChestID.MushroomChest: //Mushroom Chest
                    itemTypes.Add(ModContent.ItemType<AmmoCostEnchantmentBasic>());
                    break;
                case ChestID.GraniteChest: //Granite Chest
                    itemTypes.Add(ModContent.ItemType<AttackSpeedEnchantmentBasic>());
                    break;
                case ChestID.MarbleChest: //Marble Chest
                    itemTypes.Add(ModContent.ItemType<AmmoCostEnchantmentBasic>());
                    break;
                case ChestID.GoldDeadMansChest: //Gold Dead man's chest
                    itemTypes.Add(ModContent.ItemType<CriticalStrikeChanceEnchantmentBasic>());
                    itemTypes.Add(ModContent.ItemType<SpelunkerEnchantmentUltraRare>());
                    itemTypes.Add(ModContent.ItemType<DangerSenseEnchantmentUltraRare>());
                    itemTypes.Add(ModContent.ItemType<HunterEnchantmentUltraRare>());
                    ...
                    itemTypes.Add(ModContent.ItemType<AttackSpeedEnchantmentBasic>());
                    break;
                case ChestID.SandStoneChest: //SandStone Chest
                    itemTypes.Add(ModContent.ItemType<AmmoCostEnchantmentBasic>());
                    break;
                case ChestID.DungeonDesertChest: //Desert Chest
                    chance = 1f;
                    //itemTypes.Add(ModContent.ItemType<Enchantment>());
                    break;
            }
