...
namespace WeaponEnchantments.Effects {
    public class MaxFallSpeed : StatEffect, IVanillaStat {
        public MaxFallSpeed(float additive = 0f, float multiplicative = 1f, float flat = 0f, float @base = 0f) : base((byte)PlayerStat.MaxFallSpeed, additive, multiplicative, flat, @base) { }
