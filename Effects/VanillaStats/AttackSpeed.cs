...
namespace WeaponEnchantments.Effects {
    public class AttackSpeed : StatEffect, IClassedEffect, IVanillaStat {
        public AttackSpeed(float additive = 0f, float multiplicative = 1f, float flat = 0f, float @base = 0f, DamageClass dc = null) : base((byte)PlayerStat.AttackSpeed, additive, multiplicative, flat, @base) {
