...
namespace WeaponEnchantments.Common
{
    public class OldItemManager
    {
        ...
        private static Dictionary<string, int> firstWordNames = new Dictionary<string, int> { { "Critical", (int)EnchantmentTypeID.CriticalStrikeChance }, { "Size", (int)EnchantmentTypeID.Scale }, { "ManaCost", (int)EnchantmentTypeID.Mana }, { "Defence", (int)EnchantmentTypeID.StatDefense }, { "Velocity", (int)EnchantmentTypeID.ShootSpeed } };
