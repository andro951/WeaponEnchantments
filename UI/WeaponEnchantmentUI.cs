    ...
    public class WeaponEnchantmentUI : UIPanel
    {
		...
		public override void OnInitialize() {
            ...
            for (int i = 0; i < EnchantingTable.maxEssenceItems; i++) {
                ...
                switch (i) {
                    case 0:
                        button[xpButtonIndex].OnLeftClick += (evt, element) => ConvertEssenceToXP(0);
                        break;
                    case 1:
                        button[xpButtonIndex].OnLeftClick += (evt, element) => ConvertEssenceToXP(1);
                        break;
                    case 2:
                        button[xpButtonIndex].OnLeftClick += (evt, element) => ConvertEssenceToXP(2);
                        break;
                    case 3:
                        button[xpButtonIndex].OnLeftClick += (evt, element) => ConvertEssenceToXP(3);
                        break;
                    case 4:
                        button[xpButtonIndex].OnLeftClick += (evt, element) => ConvertEssenceToXP(4);
                        break;
                }
            ...
            for(int i = 0; i < levelSetButtons.Count; i++) {
				...
				switch (i) {
					case 0:
						button[levelSetButtonIndex].OnLeftClick += (evt, element) => {
